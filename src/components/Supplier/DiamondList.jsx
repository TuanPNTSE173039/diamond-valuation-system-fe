...
const DiamondList = () => {
    ...
    const handleDelete = (id) => {
        const updatedDiamondList = diamondList.filter((diamond) => diamond.id !== id);
        setDiamondList(updatedDiamondList);
    };
                ...
                <Table sx={{ minWidth: 700 }} aria-label="customized table">
                    <TableHead>
                        <TableRow sx={{ backgroundColor: "primary.main" }}>
                            ...
                            <TableCell align="center" sx={{ color: "white" }}>Image</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Origin</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Carat Weight</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Color</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Clarity</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Cut</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Polish</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Symmetry</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Shape</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Fluorescence</TableCell>
                            <TableCell align="center" sx={{ color: "white" }}>Cut Score</TableCell>
                        ...
                        {diamondList.map((diamond) => (
                            <TableRow key={diamond.id}>
                                ...
                                <TableCell align="center">
                                    <IconButton color="primary" onClick={() => handleEditClick(diamond.id)}>
                                        <EditIcon />
                                    </IconButton>
